...
#define DevOutputRoot "..\dist-dev\0.2.0"
...
VersionInfoDescription={#MyAppName} Windows 데스크톱 앱 개발용 설치 프로그램
...
[Files]
Source: "{#DevOutputRoot}\Hanki-0.2.0-dev-win-x64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs

...
#define RCOutputRoot "..\dist-rc\0.2.0-rc.2"
#define RCPayload "..\dist-rc\0.2.0-rc.2\Hanki-0.2.0-rc.2-win-x64"
...
VersionInfoDescription={#MyAppName} Windows 0.2.0-rc.2 출시 후보 설치 프로그램

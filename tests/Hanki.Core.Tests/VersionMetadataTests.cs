...
public sealed class VersionMetadataTests
{
    ...
    {
        Assert.AreEqual("0.2.1-rc.1", GetInformationalVersion(typeof(Hanki.Core.Models.ShortcutItem).Assembly));
        Assert.AreEqual("0.2.1-rc.1", GetInformationalVersion(typeof(Hanki.Infrastructure.AppPaths).Assembly));
